from add_object_SOR import create_objects, sor_with_objects 
import numpy as np
from visualize_Laplace import sor
list_objects1 = np.array([[3,8,4,10]], dtype=np.int64)
list_objects2 = np.array([[7,12,15,18], [14,17,2,5],[4,5,4,8]], dtype=np.int64)
...
grid_primitive_insulation, _, _ = sor_with_objects(width,eps, omega_object2, primitive_insulation) 
