...
def visualize_comparison_delta():
    ...
    plt.plot(
        np.linspace(1, gauss_seidel_k, gauss_seidel_k),
        gauss_seidel_delta,
        label="Gauss-Seidel",
    )
    plt.plot(
        np.linspace(1, sor_k_171, sor_k_171), sor_delta_171, label=r"SOR $\omega=1.71$"
    )
    plt.plot(
        np.linspace(1, sor_k_181, sor_k_181), sor_delta_181, label=r"SOR $\omega=1.81$"
    )
    plt.plot(
